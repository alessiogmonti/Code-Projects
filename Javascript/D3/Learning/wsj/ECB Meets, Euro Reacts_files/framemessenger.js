(function () {
  ...
  FrameMessenger.prototype.getVersion = function (wnd, cb) {
    if (wnd.window != wnd) {
      // Child frame communicate to parent
  ...
  FrameMessenger.prototype.act = function (wnd, action, param) {
    ...
    // For amp pages - https://amp.dev/documentation/components/amp-iframe/#iframe-resizing
    ...
    util: {
      isIFramed: function () {
        try {
          ...
          // Some browsers throw error on cross-origin frame access
          return true;
        }
      },
