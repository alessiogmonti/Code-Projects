...
import define1 from "./a33468b95d0b15b0@781.js";
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["unemployment-2.csv",new URL("./files/streamgraphT.csv",import.meta.url)]]);
...
d3.area()
    .x(d => +d.Period.toString().replace("Q","."))
    .y0(d => y(d[0]))
    .y1(d => y(d[1]))
)});
