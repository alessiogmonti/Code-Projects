...
(function() {
  ...
  sample.MainVisual.prototype.createDatGUIBox = function() {
    ...
    let animobj = {
      anim1: function(){
        self.floatingChars.uniforms['animationValue1'] = 0;
        self.floatingChars.uniforms['animationValue2'] = 1;
        self.floatingChars.uniforms['animationValue3'] = 0.45;
      },
      anim2: function(){
        self.floatingChars.uniforms['animationValue1'] = 0;
        self.floatingChars.uniforms['animationValue2'] = 0;
        self.floatingChars.uniforms['animationValue3'] = 1;
      },
      anim3: function(){
        self.floatingChars.uniforms['animationValue1'] = 0;
        self.floatingChars.uniforms['animationValue2'] = 1;
        self.floatingChars.uniforms['animationValue3'] = 0;
      }
    }

    // スライダーのGUIを追加
    var controller1 = gui.add(this, 'animationValue1', 0, 1);
    var controller2 = gui.add(this, 'animationValue2', 0, 1);
    var controller3 = gui.add(this, 'animationValue3', 0, 1);

    // 値をアニメーションさせるためのボタンを設置
    // それぞれをクリックすると、animation1, animation2, animation3メソッドが呼ばれる
    gui.add(animobj, 'anim1');
    gui.add(animobj, 'anim2');
    gui.add(animobj, 'anim3');
